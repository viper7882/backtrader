...
class TestStrategy(bt.Strategy):
    ...
    def start(self):
        ...
        if self.p.printdata:
            ...
            self.log('Starting portfolio value: %.2f' % self.broker_or_exchange.getvalue(),
                     nodate=True)
    ...
    def stop(self):
        ...
        if self.p.printdata:
            ...
            if not self.p.stocklike:
                assert '%.2f' % self.broker_or_exchange.getvalue() == '12795.00'
                assert '%.2f' % self.broker_or_exchange.get_cash() == '11795.00'
            else:
                assert '%.2f' % self.broker_or_exchange.getvalue() == '10284.10'
